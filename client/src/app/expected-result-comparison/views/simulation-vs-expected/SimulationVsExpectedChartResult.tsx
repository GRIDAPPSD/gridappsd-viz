...
import './SimulationVsExpectedChartResult.light.scss';
import './SimulationVsExpectedChartResult.dark.scss';
...
export class SimulationVsExpectedChartResult extends Component<Props, State> {
