...
export class LineChart extends Component<Props, State> {
  ...
  private _calculateXYAxisExtents(): { x: [Date, Date]; y: [number, number] } {
    ...
    return {
      x: extent<TimeSeriesDataPoint, Date>(dataPoints, point => point.timestamp), // extent() -> return the min and max value in an array
  ...
  private _renderXAxis(xAxisExtent: [Date, Date]) {
    // if(this.tickCount < 5) {
    // xAxisExtent: [Tue Feb 01 2022 12:13:01 GMT-0800 (Pacific Standard Time), Tue Feb 01 2022 12:13:01 GMT-0800 (Pacific Standard Time)]
...
// ==========3/16 before mirroring MeasurementChart.tsx=========
...
//     // console.log('axisExtents->', axisExtents);
//     // {x: [...], y: [...]}
//     // x: [Tue Feb 01 2022 12:13:01 GMT-0800 (Pacific Standard Time), Tue Feb 01 2022 12:13:01 GMT-0800 (Pacific Standard Time)]
//     // y: [0, 1]
...
//       if (suspect.points.length >= 2 && this._suspectSeriesOverlapsOtherSeries(suspect)) {
//         console.log('suspect overlapped other series -->', suspect);
//         overlappingTimeSeries.push(suspect);
//         console.log('overlappingTimeSeries-->', overlappingTimeSeries);
//       }
//     }
//     // console.log('returned overlappingTimeSeries -->', overlappingTimeSeries);
//     return overlappingTimeSeries;
//   }
...
//         && this._tooClose(current.points[current.points.length - 1], suspect.points[suspect.points.length - 1])
//       ) {
//         // console.log('overlapped true, current.points[0] ==>', current.points[0]);
//         // console.log('overlapped true, suspect.points[0] ==>', suspect.points[0]);
//         // console.log('overlapped true, current.points[current.points.length - 1] ==>', current.points[current.points.length - 1]);
//         // console.log('overlapped true, suspect.points[suspect.points.length - 1] ==>', suspect.points[suspect.points.length - 1]);
//         return true;
//       }
//     }
//     return false;
...
//   private _calculateXYAxisExtents(): { x: [Date, Date]; y: [number, number] } {
//     const [left, right] = this._xAxisSlidingWindow;
//     // console.log('#####lineChartModel.timeSeries####');
//     // console.log(this.props.lineChartModel.timeSeries);
//     // 0: {name: 'expected', points: Array(5)}
//     //    points:
//     //          0: {timestamp: Tue Feb 08 2022 09:53:44 GMT-0800 (Pacific Standard Time), measurement: 12.73575489539449}
//     //          1: {timestamp: Tue Feb 08 2022 09:53:44 GMT-0800 (Pacific Standard Time), measurement: 180}
//     // 1: {name: 'actual', points: Array(5)}
//     const dataPoints: Array<TimeSeriesDataPoint> = this.props.lineChartModel.timeSeries.reduce(
//       (accumulator, series) => {
//         for (let i = left; i > -1; i--) {
//           if (i in series.points) {
...
//   private _createXYPair(point: TimeSeriesDataPoint) {
//     // console.log('_createXYPair==>',`${this._xScale(point.timestamp)},${this._yScale(point.measurement)}`); // 11711.299342105263,47.54815406970599 x988 times with different values
//     return `${this._xScale(point.timestamp)},${this._yScale(point.measurement)}`;
//   }
