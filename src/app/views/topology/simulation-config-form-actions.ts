...
export const STORE_MRIDS = 'STORE_MRIDS';
...
export class StoreMRIDs extends Action {
  readonly type = STORE_MRIDS;
  constructor(readonly mRIDs: MRID[]) {
    super();
  }
}
...
export class SetStartTime extends Action {
