...
import './SimulationStatusLogger.styles.scss';
  ...
  render() {
    return (
      <div
        ...
        <div className='drag-handle' onMouseDown={this._mouseDown} />
        <section className='body' ref={elem => this._messagesContainer = elem}>
          {
