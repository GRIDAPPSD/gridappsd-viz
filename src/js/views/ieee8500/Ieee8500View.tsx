...
import { Button, Glyphicon, DropdownButton, MenuItem as MenuItemComponent, Modal } from 'react-bootstrap';
        ...
        return <div className="view ieee8500">
            ...
            <Modal show={this.state.showModal} onHide={this.closeModal}>
                <Modal.Header closeButton>
                    <Modal.Title>VVO Configuration</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <DropdownMenu
                        menuItems={[new MenuItem('Test', 'test', 'Test')]}
